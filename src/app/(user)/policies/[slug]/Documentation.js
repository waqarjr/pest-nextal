...
const Documentation = ({data}) => {
  ...
  return (<>
  <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={fadeUp} className=" max-w-[var(--width-custom)] mx-auto py-16 sm:py-20 px-4 sm:px-6 md:px-12 bg-secondary">
